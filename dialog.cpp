...
void Dialog::on_pushButton_addstud_clicked() {
    ...
    QFile file("D:/Project Data/learning_managment_system/csv/Students.csv"); //resource file
...
void Dialog::on_pushButton_addstud_4_clicked() {
    ...
    QFile file("D:/Project Data/learning_managment_system/csv/Prof.csv"); //resource file
    file.open(QIODevice::Append | QIODevice::Text);
